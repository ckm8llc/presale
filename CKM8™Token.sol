...
contract CKM8™Token is StandardToken, Controlled {
    
    using SafeMath for uint;

    string public constant name = "CKM8™ Token";

    string public constant symbol = "CKM8™";
    ...
    // for token circulation on platforms that integrate CKM8™ before unlockTime
    mapping (address => bool) internal precirculated;

    function CKM8™Token(uint _unlockTime) public {
